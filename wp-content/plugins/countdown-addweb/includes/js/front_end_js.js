function countdown_wp_timer(main_div_id){
...
function wp_countdown_animated_element(animation,element_id){	
		jQuery('#'+element_id).ready(function(e) {	
			if(!jQuery(jQuery('#'+element_id)).hasClass('animated') && wp_countdown_isScrolledIntoView(jQuery('#'+element_id)))	{	
...
function wp_countdown_isScrolledIntoView(elem)
{
